"""Regression checks for the watch-plat-image-pipe casebook."""
...
from casebook.harness import assert_expected, watch_plat_image_pipe_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(watch_plat_image_pipe_summary(), assert_expected())
